...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" MODIFY ("GROUDETAILSID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" ADD CONSTRAINT "NOTIFICATIONS_FK1" FOREIGN KEY ("GROUDETAILSID")
	  REFERENCES "RAHUL"."GROUPDETAILS" ("GROUPDETAILSID") ENABLE;
--------------------------------------------------------
