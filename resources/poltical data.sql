...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."GROUPDETAIL_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 120 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."GROUPFOLLOWERS_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 140 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."POLITICALUSER_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 1021 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."USER_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 1254 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "RAHUL"."GROUPDETAILS" 
   (	"GROUPDETAILSID" VARCHAR2(50 BYTE) DEFAULT NULL, 
	...
	"POLITICALUSERID" VARCHAR2(50 BYTE), 
	"DATEOFCREATION" DATE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table POLITICALUSERCREDENTIALS
--------------------------------------------------------

  CREATE TABLE "RAHUL"."POLITICALUSERCREDENTIALS" 
   (	"POLITICALUSERID" VARCHAR2(50 BYTE), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table POLITICALUSERDETAILS
--------------------------------------------------------

  CREATE TABLE "RAHUL"."POLITICALUSERDETAILS" 
   (	"POLITICALUSERID" VARCHAR2(50 BYTE), 
	"FIRSTNAME" VARCHAR2(50 BYTE), 
	"LASTNAME" VARCHAR2(50 BYTE), 
	"REGION" VARCHAR2(50 BYTE), 
	"EMAILID" VARCHAR2(50 BYTE), 
	"POLITICIANID" VARCHAR2(50 BYTE), 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index POLITICALUSERDETAILS_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "RAHUL"."POLITICALUSERDETAILS_UK1" ON "RAHUL"."POLITICALUSERDETAILS" ("EMAILID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  Constraints for Table POLITICALUSERDETAILS
--------------------------------------------------------

  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" ADD CONSTRAINT "POLITICALUSERDETAILS_UK1" UNIQUE ("EMAILID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" ADD UNIQUE ("POLITICIANID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" ADD PRIMARY KEY ("POLITICALUSERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("POLITICIANID" NOT NULL ENABLE);
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("EMAILID" NOT NULL ENABLE);
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("REGION" NOT NULL ENABLE);
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("LASTNAME" NOT NULL ENABLE);
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("FIRSTNAME" NOT NULL ENABLE);
  ALTER TABLE "RAHUL"."POLITICALUSERDETAILS" MODIFY ("POLITICALUSERID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."USERDETAILS" ADD UNIQUE ("AADHARNUMBER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."USERDETAILS" MODIFY ("AADHARNUMBER" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" ADD PRIMARY KEY ("NOTIFICATIONID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."GROUPDETAILS" ADD CONSTRAINT "GROUPDETAILS_FK1" FOREIGN KEY ("POLITICALUSERID")
	  REFERENCES "RAHUL"."POLITICALUSERDETAILS" ("POLITICALUSERID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."GROUPFOLLOWERS" ADD CONSTRAINT "GROUPFOLLOWERS_FK3" FOREIGN KEY ("POLITICALUSERID")
	  REFERENCES "RAHUL"."POLITICALUSERDETAILS" ("POLITICALUSERID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" ADD CONSTRAINT "NOTIFICATIONS_FK1" FOREIGN KEY ("GROUPFOLLOWERSID")
	  REFERENCES "RAHUL"."GROUPFOLLOWERS" ("GROUPFOLLOWERSID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table POLITICALUSERCREDENTIALS
--------------------------------------------------------

  ALTER TABLE "RAHUL"."POLITICALUSERCREDENTIALS" ADD CONSTRAINT "POLITICALUSERCREDENTIALS_FK1" FOREIGN KEY ("POLITICALUSERID")
	  REFERENCES "RAHUL"."POLITICALUSERDETAILS" ("POLITICALUSERID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table POLL
--------------------------------------------------------

  ALTER TABLE "RAHUL"."POLL" ADD CONSTRAINT "POLL_FK1" FOREIGN KEY ("USERID")
	  REFERENCES "RAHUL"."USERDETAILS" ("USERID") ENABLE;
  ALTER TABLE "RAHUL"."POLL" ADD CONSTRAINT "POLL_FK2" FOREIGN KEY ("POLLID")
	  REFERENCES "RAHUL"."POLITICALUSERDETAILS" ("POLITICIANID") ENABLE;
--------------------------------------------------------
