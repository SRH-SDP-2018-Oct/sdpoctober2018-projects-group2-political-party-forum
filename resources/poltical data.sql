...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."DISCUSSION_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 140 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "RAHUL"."POLL_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 140 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USER_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "RAHUL"."USER_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 1354 CACHE 20 NOORDER  NOCYCLE ;

--------------------------------------------------------
--  DDL for Sequence USERNOTIFICATION_SEQUENCE
--------------------------------------------------------
   
   CREATE SEQUENCE  "RAHUL"."USERNOTIFICATION_SEQUENCE"  MINVALUE 1 MAXVALUE 100000 INCREMENT BY 1 START WITH 140 CACHE 20 NOORDER  NOCYCLE ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "RAHUL"."USERNOTIFICATION" 
   (	"USERNOTIFICATIONID" VARCHAR2(50 BYTE), 
	"NOTIFICATIONID" VARCHAR2(50 BYTE), 
	"USERID" VARCHAR2(50 BYTE), 
	"ISREAD" NUMBER(4,0)
   ) SEGMENT CREATION IMMEDIATE 
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."USERNOTIFICATION" ADD PRIMARY KEY ("USERNOTIFICATIONID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "RAHUL"."USERNOTIFICATION" MODIFY ("USERID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" MODIFY ("GROUPDETAILSID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."NOTIFICATIONS" ADD CONSTRAINT "NOTIFICATIONS_FK1" FOREIGN KEY ("GROUPDETAILSID")
	  REFERENCES "RAHUL"."GROUPDETAILS" ("GROUPDETAILSID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "RAHUL"."USERCREDENTIALS" ADD CONSTRAINT "USERCREDENTIALS_FK1" FOREIGN KEY ("USERID")
	  REFERENCES "RAHUL"."USERDETAILS" ("USERID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table USERNOTIFICATION
--------------------------------------------------------

  ALTER TABLE "RAHUL"."USERNOTIFICATION" ADD CONSTRAINT "USERNOTIFICATION_FK1" FOREIGN KEY ("USERID")
	  REFERENCES "RAHUL"."USERDETAILS" ("USERID") ENABLE;
  ALTER TABLE "RAHUL"."USERNOTIFICATION" ADD CONSTRAINT "USERNOTIFICATION_FK2" FOREIGN KEY ("NOTIFICATIONID")
	  REFERENCES "RAHUL"."NOTIFICATIONS" ("NOTIFICATIONID") ENABLE;
