...
public class DynamicJasperReportGroupProgressReport {
	...
	public static void main(String[] args)  throws ServiceNotFoundException {
		...
		try {
			...
			"select groupprogressreportid, workname, workbody, contractor, startdate, enddate, dateofcompletion, fund, reportdate, dateofreport, groupdetailsid from groupprogressreport ")
					.executeQuery();
		FastReportBuilder fastReportBuilder = new FastReportBuilder();
		DynamicReport dynamicReport = fastReportBuilder.addColumn("Group Progress Report ID", "groupprogressreportid", String.class.getName(), 20)
													   ...
													   .addColumn("Date of Report", "dateof report", String.class.getName(), 20)
